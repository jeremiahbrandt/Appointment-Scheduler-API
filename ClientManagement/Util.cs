...
namespace ClientManagement
{
    class Util
    {
        public static async Task<string> GetUid(HttpRequest req)
        {
            ...
            var token = await FirebaseAuth.DefaultInstance.VerifyIdTokenAsync(req.Headers["Authorization"].ToString().Split(" ")[1]);
            return token.Uid;
        }
        ...
        public static string GetConnectionString()
        {
            ...
            //return "Server=tcp:se3910project.database.windows.net,1433;Initial Catalog=devdb;Persist Security Info=False;User ID=se3910admin;Password=$qqv5M#E14$q%8CO7i1g;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
